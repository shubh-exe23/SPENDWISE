...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() async {
    ...
    if (result['success']) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const MyHomePage(), // Clean and error-free
        ),
      );
    } else {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // ── header ──
                Text('Welcome\nBack! 👋', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: textColor, height: 1.2)),
  ...
  child: const Text('Forgot Password?', style: TextStyle(color: _jade, fontSize: 13, fontWeight: FontWeight.w600)),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: iconBg, borderRadius: BorderRadius.circular(12), border: Border.all(color: borderColor)),
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'We\'ll ask for notification permission after login to alert you about budget warnings and limits.',
                          style: TextStyle(fontSize: 12, color: isDarkMode ? Colors.white70 : Colors.grey.shade600, height: 1.4),
                        ),
                      ),
                    ],
                  ),
